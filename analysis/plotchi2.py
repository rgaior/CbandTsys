...
#plt.scatter(ftheta[fnroffit > factorfit*maxnroffit],fphi[fnroffit > factorfit*maxnroffit],s=200,c=fnroffit[fnroffit > factorfit*maxnroffit],vmin=np.min(fnroffit[fnroffit > factorfit*maxnroffit]),vmax=np.max(fnroffit[fnroffit > factorfit*maxnroffit]))
plt.scatter(a_theta,a_phi,s=20,c=a_nroffit)
plt.colorbar()
plt.show()
