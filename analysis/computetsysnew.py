...
#        print fname
        ...
        print ' datapoint = ', datapoint, 'and max = ' , np.max(data)
...
#                continue 
        ...
        a_errtsys = np.append(a_errtsys,0.1)
#        a_sim = np.append(a_sim,)
        a_simtofmax = np.append(a_simtofmax,float(ls[4]))
        a_tofmax = np.append(a_tofmax,theres.fitresult[0][2])
        a_errortofmax = np.append(a_errortofmax,0.5)
